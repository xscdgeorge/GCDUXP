  ...
  return (
    <div className="bg-white min-h-screen text-gray-900 font-sans selection:bg-orange-100 pb-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          <div className="lg:col-span-8">
            <div className="flex gap-3 mb-6">
              <span className="px-3 py-1 bg-orange-50 text-orange-600 rounded-full text-xs font-bold uppercase tracking-wider">eSignature SaaS</span>
              <span className="px-3 py-1 bg-gray-50 text-gray-500 rounded-full text-xs font-bold uppercase tracking-wider">2023 - 2024</span>
            </div>
            <h1 className="text-5xl md:text-7xl font-serif leading-tight mb-8">
              JioSign: Mobile-First <br/>
              <span className="text-gray-400 italic">eSign for India</span>
            </h1>
            <p className="text-xl text-gray-600 max-w-2xl leading-relaxed">
              Redesigning the eSignature experience for a mobile-first nation, achieving 1M+ documents signed daily with AI-powered accessibility.
            </p>
          </div>
      ...
      <section className="px-6 md:px-10 max-w-7xl mx-auto mb-32">
        <div className="rounded-[40px] overflow-hidden aspect-[21/9] shadow-2xl relative group">
          <img 
            src="https://images.unsplash.com/photo-1550751827-4bd374c3f58b?auto=format&fit=crop&q=80&w=2000" 
            alt="JioSign Interface" 
        ...
        <div className="lg:col-span-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-4">
              ...
              <h3 className="text-xl font-bold">Trust & Communication</h3>
            ...
            <div className="space-y-4">
              ...
              <h3 className="text-xl font-bold">Strategic Pivot</h3>
              <p className="text-gray-500 text-sm leading-relaxed">
      ...
      {/* AI Enhancements */}
      <section className="bg-orange-600 text-white py-32 mb-32 relative overflow-hidden">
