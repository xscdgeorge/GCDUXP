  ...
  return (
    <div className="bg-zinc-950 min-h-screen text-gray-100 font-sans selection:bg-white selection:text-gray-900 pt-[74px]">
      ...
      <section className="px-6 md:px-10 max-w-3xl mx-auto mb-20">
        ...
        <p className="text-[#6B5A45] dark:text-gray-400 leading-[1.8] mb-6">
          I took ownership of the product by convincing leadership that the project required embedded designers with a sense of stake, rather than the agency-style approach of the previous team. I argued that integrating the eSign pattern into the Jio Design System (JDS) could potentially increase internal adoption organically—a challenge I had already successfully navigated when we established "Sign in with JioID" as the first SaaS pattern in the JDS.
        </p>
        <p className="text-[#6B5A45] dark:text-gray-400 leading-[1.8] mb-6">
      ...
      <section className="px-6 md:px-10 max-w-3xl mx-auto mb-32">
        <h2 className="text-[42px] font-serif mb-6">Results so far<span className="text-orange-500">.</span></h2>
